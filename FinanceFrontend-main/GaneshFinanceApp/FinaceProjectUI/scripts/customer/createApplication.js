...
function validate(loan_id, amount, tenure, emi, aadharElement, panElement) {
...
async function getformData() {
    ...
    var flag = validate(loan_id, amount, tenure, emi, aadharElement, panElement)
    ...
    if (flag == 1) {
        ...
        req.onreadystatechange = async function () {
            if (req.status === 200 && req.readyState === 4) {
                ...
                if (res.statusCode == 200) {
                    ...
                    window.open("../../view/customer/customerProfile.html", '_self')
                } else {
        ...
        req.open('POST', 'http://localhost:8080/FinanceBackend/rest/customer/addLoanApplication', true)
